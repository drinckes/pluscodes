...
Messages.prototype.getWithLanguage = function(language, key, params) {
  if (language in LocalisedMessages && key in LocalisedMessages[language]) {
    ...
    if ("p" in LocalisedMessages[language][key]) {
...
LocalisedMessages["ar"] = {
  ...
  "browser-problem-msg": {
    "m": "لا يدعم المتصفح الذي تستخدمه كل الميزات التي نحتاجها، مثل الموقع والبوصلة.<br/><br/>نوصي باستخدام Chrome أو Firefox أو Opera."
  },
  "compass-check-fail-msg": {
    "m": "البوصلة على جهازك لا تبلغ عن الاتجاه. قد لا تكون البوصلة معتمدة من جهازك، أو قد لا تعمل بشكلٍ صحيح."
  },
  "compass-check-msg": {
    "m": "قد تكون هناك مشكلة في قراءة البوصلة.<br/><br/>لاختبارها، أمسك بجهازك بشكلٍ مستوي وأدره في دائرة.<br/><br/>عند الانتهاء من تدوير الجهاز بالكامل، انقر على الزر أدناه."
  },
  "compass-check-ok": {
    "m": "يبدو أن البوصلة على جهازك تعمل بشكلٍ جيد!"
  },
  "discuss": {
    "m": "مناقشة"
  },
  ...
  "extend-failure-msg": {
    "m": "لمعرفة مكان وجود $OLC$، يلزمنا الحصول على موقعك الحالي، أو يلزمك إدراج بلدة أو مدينة في المعلومات.<br/><br/>تحقق من أن متصفحك يسمح بتحديد الموقع، وأن خدمات المواقع قد تم تمكينها على جهازك.",
    "p": {
      "OLC": {}
    }
  },
  "feedback-detail": {
    "m": "أرسل تعليقات. أطلعنا على ما تحبه، أو على العناصر ضعيفة الأداء وسنحاول تحسينها."
  },
  "geocode-fail": {
    "m": "تعذّر على خدمة العناوين في Google تحديد موقع $ADDRESS$.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-not-loaded": {
    "m": "لم يتم تحميل خدمة العناوين في Google، ويتعذّر تحديد موقع $ADDRESS$.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-reverse-fail": {
    "m": "تعذّر الحصول على أي معلومات للمنطقة المحلية (حدث خطأ في خدمة ترميز المناطق الجغرافية‬ في Google)"
  },
  "geocoder-no-info": {
    "m": "لا تتوفر لخدمة ترميز المناطق الجغرافية‬ في Google معلومات للعناوين في هذه المنطقة. قد يكون بمقدورك استخدام رمز plus+‎ مع اسم بلدة كبيرة إذا كانت موجودة في حدود 40 كم."
  },
  "google-maps": {
    "m": "خرائط Google"
  },
  "help-01-0": {
    "m": "<h2>رمزك البريدي الشخصي</h2><p>تكون رموز plus+‎ عبارة على رموز قصيرة لأي موقع في أي مكان. ويمكنك استخدامها لتوجيه الأشخاص إلى موقعك بالضبط، بشكلٍ سريع ويُعتمد عليه.</p>"
  },
  "help-02-0": {
    "m": "<h2>ما المقصود برمز plus+‎؟</h2><p>رمز plus+‎ عبارة عن رمز قصير يتألف من ستة أو سبعة أحرف وأرقام، مثل <b>$EXAMPLE_CODE$</b>، أو يُضاف إلى بلدة أو مدينة مثل هذا <b>$EXAMPLE_CODE$ نيروبي</b>.</p><p>ويسمح لك هذا الرمز بإعطاء أي شخص الموقع الدقيق دون الاعتماد على أسماء الشوارع أو أرقام المباني.</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      }
  ...
  "help-02-2": {
    "m": "<h2>هل أنا بحاجة إلى تقديم طلب للحصول على رمز plus+‎؟</h2><p>كلا، فرموز plus+‎ موجودة فعلاً لأي مكان، ويمكن لأي شخص استخدامها مجانًا.</p><p>للحصول على رمز plus+‎ لمكان معين، ما عليك سوى سحب الخريطة لتمييز المكان المطلوب.</p>"
  },
  "help-03-0": {
  ...
  "help-03-1": {
    "m": "<h2>هل يحتوي الموقع على أكثر من رمز plus+‎ واحد؟</h2><p>كلا. يحتوي أي مكان على رمز plus+‎ واحد فقط.</p>"
  },
  "help-03-2": {
    "m": "<h2>هل يمكنني حفظها؟</h2><p>لحفظ أحد رموز plus+‎، ما عليك سوى إنشاء إشارة مرجعية للصفحة. وعند فتح الإشارة المرجعية، ستعرض لك المكان.</p>"
  },
  "help-03-3": {
    "m": "<h2>هل يمكنني استخدام هذه الخدمة عندما لا تتوافر لديّ شبكة؟</h2><p>نعم، يمكنك ذلك! بعد الانتهاء من تحميل هذه الصفحة على الهاتف أو جهاز الكمبيوتر الذي تستخدمه، ستحتفظ الخدمة بنسخة وتسمح لك بتحميلها حتى دون وجود اتصال بالشبكة.</p>"
  },
  "help-03-4": {
    "m": "<h2>هل يمكنني الحصول على الاتجاهات؟</h2><p>هناك وضع للبوصلة يعرض لك الاتجاه والمسافة من مكان وجودك إلى رمز plus+‎ الحالي. وتحتوي القائمة الرئيسية على روابط مؤدية إلى مقدمي خرائط مختلفين يمكنك الاستعانة بهم.</p>"
  },
  "help-03-5": {
    "m": "<h2>منطقة رمز plus+‎ كبيرة جدًا!</h2><p>إذا اخترت التكبير إلى أكثر من ذلك، فسيكون الرمز مخصصًا لمنطقة أصغر.</p>"
  },
  "help-03-6": {
    "m": "<h2>العنوان الذي تعرضه غير صحيح!</h2><p>العنوان المقدم مجرد اقتراح، ويُستخدم لتقليل طول الرمز الذي تحتاج إلى استخدامه. يمكنك تجربة عناوين أخرى في مربّع البحث.</p>"
  },
  "input-prompt": {
    "m": "أدخل رمز plus+‎ أو عنوانًا أو اسحب الخريطة"
  },
  "location-prompt": {
    "m": "تحتاج هذه الخدمة إلى استخدام موقعك. إذا عرض المتصفح رسالة مطالبة، يُرجى السماح بذلك."
  },
  "map-error": {
    "m": "يتعذّر تحميل خرائط Google. تأكد من توافر شبكة تعمل فعلاً وجرِّب إعادة تحميل الصفحة.<br/><br/>يمكنك إدخال رموز plus+‎ مع أو دون رمز المنطقة، واستخدام البوصلة، ولكنك لن تتمكن من إدخال عناوين، أو رموز plus+‎ مع عناوين، إلى أن يتم عرض الخرائط."
  },
  "osm-maps": {
    "m": "فتح خريطة الشارع"
  },
...
LocalisedMessages["bn"] = {
  ...
  "browser-problem-msg": {
    "m": "আপনি যে ব্রাউজারটি ব্যবহার করছেন সেটি আমাদের যে বৈশিষ্ট্য দরকার যেমন আপনার অবস্থান, কম্পাস প্রভৃতি সমর্থন করে না l<br/><br/>আমরা Chrome, Firefox অথবা Opera ব্যাবহার করার পরামর্শ দিই l"
  },
  "compass-check-fail-msg": {
    "m": "আপনার ডিভাইসের কম্পাসটি ঠিকমত দিক নির্দেশ করছে না l আপনার ডিভাইস হয়তো কম্পাসটিকে সাপোর্ট করছে না অথবা কম্পাসটি ঠিকমত কাজ করছে না l"
  },
  "compass-check-msg": {
    "m": "কম্পাসটি পড়তে কিছু সমস্যা হতে পারে l<br/><br/>সেটি পরীক্ষা করার জন্য ডিভাইসটিকে সোজাভাবে ধরুন আর বৃত্তাকারে ঘোরাতে থাকুন l<br/><br/>যখন সেটি সম্পূর্ণ ঘোরানো হয়ে যাবে, তখন নিচের বোতামটি টিপুন l"
  },
  "compass-check-ok": {
    "m": "আপনার ডিভাইসের কম্পাসটি দেখে ঠিক মনে হচ্ছে!"
  },
  "discuss": {
    "m": "আলোচনা"
  },
  ...
  "extend-failure-msg": {
    "m": "$OLC$ কোথায় সেটা জানতে হলে আপনার বর্তমান অবস্থান জানা প্রয়োজন, অথবা আপনাকে তথ্যের জায়গায় কোনও শহর বা নগরের নাম অন্তর্ভুক্ত করতে হবে l<br/><br/>লক্ষ্য রাখবেন যাতে আপনার ব্রাউজার আপনার অবস্থান জানানোর অনুমতি দেয় আর আপনার ডিভাইস অবস্থান পরিষেবাগুলিকে সক্ষম রাখে l",
    "p": {
      "OLC": {}
    }
  },
  "feedback-detail": {
    "m": "আমাদের মতামত পাঠান l আপনার কি পছন্দ, বা কোনটা কাজ করছে না সেটা আমাদের জানান আর আমরা সেটা আরো উন্নত করতে চেষ্টা করব l"
  },
  "geocode-fail": {
    "m": "Google ঠিকানা সংক্রান্ত পরিষেবা খুঁজে বের করতে পারছে না $ADDRESS$l",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-not-loaded": {
    "m": "Google's ঠিকানা সংক্রান্ত পরিষেবা লোড করা যাচ্ছে না, খুঁজে পাওয়া যাচ্ছে না $ADDRESS$l",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-reverse-fail": {
    "m": "বর্তমান অবস্থানের কোনও তথ্য পাওয়া যায়নি (Google's geocoder পরিষেবায় ত্রুটি দেখা দিয়েছে)"
  },
  "geocoder-no-info": {
    "m": "Google's geocoder পরিষেবার কোনো ঠিকানা সংক্রান্ত তথ্য এই এলাকায় পাওয়া যাচ্ছে না l আপনি অবশ্যই কোনো বড় শহরের নাম দিয়ে plus+code ব্যাবহার করতে পারবেন যদি 40 কিমি. -এর মধ্যে কোনোটি থাকে l"
  },
  "google-maps": {
    "m": "Google মানচিত্র"
  },
  "help-01-0": {
    "m": "<h2>আপনার নিজস্ব ব্যাক্তিগত পোস্টকোড</h2><p>plus+codes হল যেকোন স্থান বা জায়গায় ব্যাবহার করার জন্য ছোট কোড l অতি দ্রুত আপনার স্থান অন্যদের প্রদর্শন করার জন্য আপনি সেগুলোকে ব্যাবহার করতে পারেন এবং সেগুলো নির্ভরযোগ্য l</p>"
  },
  "help-02-0": {
    "m": "<h2>plus+code কি?</h2><p>plus+code হল অক্ষর আর সংখ্যা দিয়ে গঠিত ছয় বা সাত অক্ষরের একটি কোড, যেমন <b>$EXAMPLE_CODE$</b>, অথবা শহর বা নগরের সমন্বয়ে গঠিত যেমন <b>$EXAMPLE_CODE$ নাইরোবি</b>.</p><p>সেগুলি সবাইকে সঠিক অবস্থান জানাবে যেটি রাস্তার নাম বা বাড়ির সংখ্যার উপর নির্ভর করে না l</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      }
  ...
  "help-03-1": {
    "m": "<h2>কোনো একটি অবস্থানের কি একটির বেশি plus+code আছে?</h2><p>না l কোনো একটি স্থানের শুধুমাত্র একটিই plus+code আছে l</p>"
  },
  "help-03-2": {
    "m": "<h2>আমি কি সেগুলোকে সেভ করতে পারি?</h2><p>plus+code সেভ করতে গেলে এই পেজের জন্য একটি বুকমার্ক তৈরি করুন l যখন আপনি বুকমার্কটি খুলবেন সেটি আপনাকে সেই জায়গাটা দেখাবে l</p>"
  },
  "help-03-3": {
    "m": "<h2>আমার যদি নেটওয়ার্ক না থাকে তাহলে আমি কি এটা ব্যাবহার করতে পারব?</h2><p>অবশ্যই! যখনই আপনি আপনার ফোন বা কম্পিউটারে পেজটি লোড করবেন, এটি তার একটি প্রতিলিপি রেখে দেবে আর আপনার নেটওয়ার্ক সংযোগ না থাকলেও আপনাকে এটি লোড করতে দেবে l</p>"
  },
  "help-03-4": {
    "m": "<h2>আমি কি কোনো দিক নির্দেশ পেতে পারি?</h2><p>সেখানে কম্পাস মোড রয়েছে যেটা আপনি যেখানে রয়েছেন সেখান থেকে স্থানীয় plus+code পর্যন্ত রাস্তার অভিমুখ আর দূরত্ব দেখাবে l প্রধান মেনুতে আপনি বিভিন্ন মানচিত্র প্রদানকারীর লিঙ্ক ব্যবহার করতে পারেন l</p>"
  },
  "help-03-5": {
    "m": "<h2>আমার plus+code এরিয়াটি খুবই বড়!</h2><p>আপনি যদি ভিতরের দিকে আরো জুম্ বাড়ান তাহলে সেই কোডটি একটি অতি ছোট স্থানের জন্য হবে l</p>"
  },
  "help-03-6": {
    "m": "<h2>আপনি যে ঠিকানাটি দেখাচ্ছেন সেটি ভুল!</h2><p>যে ঠিকানাটি দেখানো হয়েছে সেটি একটি প্রস্তাব মাত্র l যে code আপনি ব্যাবহার করবেন তার দৈর্ঘ্য ছোট করার জন্য এটি ব্যাবহার করা হয়েছে l আপনি অনুসন্ধান বাক্সে অন্য কোনো ঠিকানাও ব্যাবহার করতে পারেন l</p>"
  },
  "input-prompt": {
    "m": "plus+code, ঠিকানা দিন অথবা মানচিত্রটা টেনে নিয়ে আসুন"
  },
  "location-prompt": {
    "m": "এই পরিষেবা আপনার বর্তমান অবস্থান জানতে চায় l যদি আপনার ব্রাউজার আপনার অনুমতি চায়, আপনি দয়া করে এটি অনুমোদন করুন l"
  },
  "map-error": {
    "m": "Google মানচিত্র লোড করা যাচ্ছে না l নেটওয়ার্ক কাজ করছে কি না দেখে নিন আর অনুগ্রহ করে পেজটি পুনরায় লোড করুন l<br/><br/>আপনি এরিয়া কোড দিয়ে বা এরিয়া code ছাড়া plus+codes দিতে পারবেন আর কম্পাস ব্যাবহার করতে পারবেন কিন্তু আপনি আপনার ঠিকানা বা plus+codes সহ ঠিকানা দিতে পারবেন না যতক্ষণ না মানচিত্রে প্রদর্শন করা যায় l"
  },
  "osm-maps": {
    "m": "ওপেন স্ট্রিট ম্যাপ"
  },
  "ui-feedback": {
    "m": "প্রতিক্রিয়া"
  },
  ...
  "waiting-location": {
    "m": "অবস্থানের জন্য অপেক্ষা করা হচ্ছে..."
  }
}
LocalisedMessages["cs"] = {
  "input-prompt": {
    "m": "Napište plus+code nebo adresu nebo posuňte mapu",
    "description": "Text to display in the search box to tell a user how to interact with the application"
  },
  "map-error": {
    "m": "Nepodařilo se načíst Google Mapy. Ujistěte se že jste připojeni k internetu a zkuste znovu načíst stránku<br/><br/>Můžete zadat plus+code i bez kódu oblasti a použít kompas, ale nebudete moci zadat adresu, nebo plus+code s adresou, dokud se nezobrazí mapa.",
    "description": "Message to display when Google Maps can't be loaded"
  },
  "browser-problem-msg": {
    "m": "Váš prohlížeč nepodporuje všechny doplňky které potřebujeme, jako je úmístění nebo kompas.<br/><br/>Doporučujeme použít Chrome, Firefox ne Operu.",
    "description": "Message to show when the browser doesn't support location or orientation"
  },
  "geocoder-no-info": {
    "m": "Geokódovací služba Googlu nenalezla tuto adresu v oblasti. Zkuste použít plus+kód s názvem většího města, pokud je nějaké do vzdálenosti 40km.",
    "description": "If Google can't find any location name in the area"
  },
  "extend-failure-msg": {
    "m": "To work out where $OLC$ is, we need your current location, or you need to include a town or city in the information.<br/><br/>Check that your browser is allowing location, and that location services are enabled on your device.",
    "description": "Shown when the user location cannot be determined"
  },
  "geocode-not-loaded": {
    "m": "Google's address service se nepodařilo načíst, $ADDRESS$ nelze nalézt.",
    "description": "The address the user entered cannot be located, because the Google geocoding service isn't loaded"
  },
  "geocode-fail": {
    "m": "Služba Google address nemůže nelézt $ADDRESS$.",
    "description": "The address the user entered cannot be located"
  },
  "geocode-reverse-fail": {
    "m": "Nepodařilo se načíst žádné informace o vašem umístění (Chyba je na straně Google geocoder služby)",
  ...
  "compass-check-msg": {
    "m": "Nepodařilo se načíst informace z kompasu.<br/><br/>Abyste to vyzkoušeli, držte zařízení rovně a otáčejte s ním v kruhu.<br/><br/>Až ho úpně otočíte, klikněte na tlačítko níže.",
  ...
  "compass-check-fail-msg": {
    "m": "Kompas ve vašem zařízení nehlásí směr. Vaše zařízení ho možná nepodporuje a nebo nefunguje správně.",
    "description": "The device does not have a compass, or it cannot be read correctly"
  },
  "compass-check-ok": {
    "m": "Kompas ve vašem zařízení funguje perfektně!",
    "description": "The compass on the device can be read and looks good"
  },
  "waiting-for-compass-1": {
    "m": "Čekání na",
  ...
  "location-prompt": {
    "m": "Tato služba potřebuje použít vaší polohu. Pokud se vás prohlížeč zeptá, prosím povolte to.",
  ...
  "help-01-0": {
    "m": "<h2>Your own personal postcode</h2><p>plus+codes are short codes for any location, anywhere. You can use them to guide people to your exact location, fast and reliably.</p>",
    "description": "First help page explaining what plus+codes are"
  },
  "help-02-0": {
    "m": "<h2>Co e to plus+code?</h2><p>Plus+code je krátký kod ze šesti nebo sedmi písmen a čísel, například <b>$EXAMPLE_CODE$</b>, nebo kombinovaný s měatem, například <b>$EXAMPLE_CODE$ Nairobi</b>.</p><p>Umožňuje vám sdělit přesnou polohu bez názvů ulic, nebo čísel budov.</p>",
  ...
  "help-02-1": {
    "m": "<h2>Jak zjistím, kde se plus+code nachází?</h2><p>Když zadáte plus+code (<b>$EXAMPLE_CODE$</b>) na vašem telefonu nebo počítači, najdete nejbližší shodu. Takto získáte správnou polohu, pokud jste v okruhu 40km od daného místa.</p><p>Pokud se nacházíte dále použijte název města (<b>$EXAMPLE_CODE$ Nairobi</b>), nebo použijte plus+code spolu s kódem oblasti (<b>$FULL_CODE$</b>).</p>",
    "description": "Help page section",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
  ...
  "help-02-2": {
    "m": "<h2>Musím se registrovat abych mohl používat plus+code?</h2><p>Ne, plus+code už existují všude a každý je může volně používat.</p><p>K získání plus+code pro určité místo jenom posuňte mapu a vyznačte požadovanou oblast.</p>",
    "description": "Help page section"
  },
  "help-03-0": {
    "m": "<h2>Co znamenají jednotlivé části plus+code?</h2><p>Například kód <b>$FULL_CODE$</b>, <b>$CODE_PART_1$</b> je kód regionu (přibližně 100 x 100 kilometrů). <b>$CODE_PART_2$</b> je kód města (5 x 5 kilometrů). <b>$CODE_PART_3$</b> je kód sousedství (250 x 250 meters). Za<b>+</b>, <b>$CODE_PART_4$</b> je kód budovy (14 x 14 metrů). Může být následován jednočíselným kódem dveří, Pokud kód budovy sahá přes více staveb.</p><p>Obvykle není kód regionu nutný a někdy nemusíte použít ani kód města.</p>",
  ...
  "help-03-1": {
    "m": "<h2>Má místo více než jeden plus+code?</h2><p>Ne. Každé místo má jenom jeden plus+code.</p>",
    "description": "Help page section"
  },
  "help-03-2": {
    "m": "<h2>Můžu si kódy uložit?</h2><p>K uložení plus+code, stačí vytvořit záložku. Když jí otevřete, ukáže vám dané místo.</p>",
    "description": "Help page section"
  },
  "help-03-3": {
    "m": "<h2>Můžu to používat i když jsem bez internetu?</h2><p>Ano! Poté co načtete tuto stránku do svého počítače nebo telefonu, Uloží se kopie díky níž budete moci míst načíst i bez internetu.</p>",
    "description": "Help page section telling the user that it should work offline"
  },
  "help-03-4": {
    "m": "<h2>Můžu získat směr?</h2><p>K tomu slouží kompas mód který vám ukáže směr a vzdálenost od plus+code. Hlavní menu odkazuje na mapy jiných poskytovatelů, které můžete použít.</p>",
    "description": "Help page section"
  },
  "help-03-5": {
    "m": "<h2>Moje plus+code oblast je příliš velká!</h2><p>Když více zazoomujete, k=od bude pro menší oblast.</p>",
    "description": "Help page section"
  },
  "help-03-6": {
    "m": "<h2>Adresa, kterou ukazujete je špatně!</h2><p>Adresa je pouze odhad. Je použita pouze ke zkrácení delky kódu který si musíte zapamatovat nebo uložit. Můžete zkusit vyhledat jiné adresy.</p>",
    "description": "Help page section"
  },
  "feedback-detail": {
    "m": "Poslat zpětnou vazbu. Dejte nám vědět co se vám líbí, nebo co nefunguje a my se pokusíme to opravit.",
    "description": "Message"
  },
  "discuss": {
    "m": "Diskuse"
 ...
 * "p" object, listing each value and defining the content. The
...
LocalisedMessages["en"] = {
  "input-prompt": {
    "m": "Enter a plus+code, address or drag the map",
    "description": "Text to display in the search box to tell a user how to interact with the application"
  },
  "map-error": {
    "m": "Cannot load Google Maps. Make sure you have a working network and try reloading the page.<br/><br/>You can enter enter plus+codes with or without the area code, and use the compass, but you will not be able to enter addresses, or plus+codes with addresses, until maps are displayed.",
    "description": "Message to display when Google Maps can't be loaded"
  },
  "browser-problem-msg": {
    "m": "The browser you are using does not support all the features we need, such as location and compass.<br/><br/>We recommend using to Chrome, Firefox or Opera.",
    "description": "Message to show when the browser doesn't support location or orientation"
  },
  "geocoder-no-info": {
    "m": "Google's geocoder service has no address information in this area. You might be able to use a plus+code with the name of a large town, if there is one within 40km.",
    "description": "If Google can't find any location name in the area"
  },
  "extend-failure-msg": {
    "m": "To work out where $OLC$ is, we need your current location, or you need to include a town or city in the information.<br/><br/>Check that your browser is allowing location, and that location services are enabled on your device.",
  ...
  "geocode-not-loaded": {
    "m": "Google's address service is not loaded, can't locate $ADDRESS$.",
    "description": "The address the user entered cannot be located, because the Google geocoding service isn't loaded"
  },
  "geocode-fail": {
    "m": "Google's address service can't locate $ADDRESS$.",
    "description": "The address the user entered cannot be located"
  },
  "geocode-reverse-fail": {
    "m": "Could not get any locality information (Google's geocoder service had an error)",
    "description": "Google returned no address information for the location shown because the service had an unspecified error"
  },
  "google-maps": {
    "m": "Google Maps",
  ...
  "compass-check-msg": {
    "m": "There could be a problem reading the compass.<br/><br/>To test it, hold your device flat and turn around in a circle.<br/><br/>When you have turned completely around, tap the button below.",
    "description": "If the orientation of the device can't be determined, this asks the user to turn the device around in a circle to test it"
  },
  "compass-check-fail-msg": {
    "m": "The compass on your device is not reporting the direction. The compass might not be supported by your device, or it might not be working properly.",
    "description": "The device does not have a compass, or it cannot be read correctly"
  },
  "compass-check-ok": {
    "m": "The compass on your device looks OK!",
  ...
  "location-prompt": {
    "m": "This service needs to use your location. If your browser asks, please allow it.",
    "description": "Notifies the user that they may be asked to share their location"
  },
  "ui-help": {
    "m": "Help",
  ...
  "help-02-0": {
    "m": "<h2>What is a plus+code?</h2><p>A plus+code is a short code made up of six or seven letters and numbers, like <b>$EXAMPLE_CODE$</b>, or combined with a town or city like this <b>$EXAMPLE_CODE$ Nairobi</b>.</p><p>They let you give someone an exact location that doesn't depend on street names or building numbers.</p>",
    "description": "Help page section",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
  ...
  "help-02-2": {
    "m": "<h2>Do I need to apply for a plus+code?</h2><p>No, plus+codes already exist for everywhere and anyone can use them for free.</p><p>To get the plus+code for a place just drag the map to highlight the place you want.</p>",
    "description": "Help page section"
  },
  "help-03-0": {
    "m": "<h2>What are the parts of the code?</h2><p>For our example code <b>$FULL_CODE$</b>, <b>$CODE_PART_1$</b> is the region code (roughly 100 x 100 kilometers). <b>$CODE_PART_2$</b> is the city code (5 x 5 kilometers). <b>$CODE_PART_3$</b> is the neighbourhood code (250 x 250 meters). After the <b>+</b>, <b>$CODE_PART_4$</b> is the building code (14 x 14 meters). It can be followed by a single digit door code, if the building size code extends over more than one building.</p><p>Usually, the region code isn't needed, and sometimes you will be able to drop the city code as well.</p>",
    "description": "Help page section giving the structure of the codes",
    "p": {
      "FULL_CODE": {
        "c": "6GCRMQRG+59"
  ...
  "help-03-1": {
    "m": "<h2>Does a location have more than one plus+code?</h2><p>No. Any place only has one plus+code.</p>",
    "description": "Help page section"
  },
  "help-03-2": {
    "m": "<h2>Can I save them?</h2><p>To save a plus+code, just create a bookmark for the page. When you open the bookmark, it will show you the place.</p>",
    "description": "Help page section"
  },
  "help-03-3": {
    "m": "<h2>Can I use this when I don't have a network?</h2><p>Yes! After you have loaded this page on your phone or computer, it will keep a copy and let you load it even without a network connection.</p>",
    "description": "Help page section telling the user that it should work offline"
  },
  "help-03-4": {
    "m": "<h2>Can I get directions?</h2><p>There is a compass mode that shows you the direction and distance from where you are to the current plus+code. The main menu has links to different map providers you can use.</p>",
    "description": "Help page section"
  },
  "help-03-5": {
    "m": "<h2>My plus+code area is too large!</h2><p>If you zoom in further, the code will be for a smaller area.</p>",
    "description": "Help page section"
  },
  "help-03-6": {
    "m": "<h2>The address you show is wrong!</h2><p>The address given is just a suggestion. It is used to reduce the length of the code you need to use. You can try other addresses in the search box.</p>",
    "description": "Help page section"
  },
  "feedback-detail": {
    "m": "Send feedback. Let us know what you like, or what is not working and we'll try to improve.",
    "description": "Message"
  },
  "discuss": {
    "m": "Discuss"
...
LocalisedMessages["es"] = {
  ...
  "browser-problem-msg": {
    "m": "El navegador que utilizas no admite todas las funciones que necesitamos, como la ubicación y la brújula.<br/><br/>Te recomendamos que utilices Chrome, Firefox u Opera."
  },
  "compass-check-fail-msg": {
    "m": "La brújula de tu dispositivo no apunta a ninguna dirección. Puede ser que no sea compatible con tu dispositivo o que no funcione correctamente."
  },
  "compass-check-msg": {
    "m": "Es posible que haya surgido un problema al leer la brújula.<br/><br/>Para probarla, mantén el dispositivo en posición horizontal y gira sobre ti mismo 360º.<br/><br/>Cuando hayas dado toda la vuelta, toca el botón que aparece debajo."
  },
  "compass-check-ok": {
    "m": "La brújula del dispositivo funciona bien."
  },
  "discuss": {
    "m": "Foro de debate"
  },
  ...
  "extend-failure-msg": {
    "m": "Para determinar la ubicación de $OLC$, necesitamos tu ubicación actual o que incluyas una ciudad o una población en la información que proporcionas.<br/><br/>Comprueba que el navegador admita la función de ubicación y que los servicios de ubicación estén habilitados en tu dispositivo.",
    "p": {
      "OLC": {}
    }
  },
  "feedback-detail": {
    "m": "Envía sugerencias. Dinos qué te gusta o qué no funciona e intentaremos mejorarlo."
  },
  "geocode-fail": {
    "m": "El servicio de direcciones de Google no puede localizar $ADDRESS$.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-not-loaded": {
    "m": "El servicio de direcciones de Google no está cargado, por lo que no es posible localizar $ADDRESS$.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-reverse-fail": {
    "m": "No se ha podido obtener ninguna información de la localidad (se ha producido un error en el servicio de codificador geográfico de Google)"
  },
  "geocoder-no-info": {
    "m": "El servicio de codificador geográfico de Google no tiene ninguna información de dirección de esta área. Puedes utilizar un código plus+code con el nombre de una ciudad grande, si hay alguna en un radio de 40 km a la redonda."
  },
  "google-maps": {
    "m": "Google Maps"
  },
  "help-01-0": {
    "m": "<h2>Tu propio código postal personal</h2><p>Los códigos plus+code son códigos cortos de ubicaciones de todo el mundo. Puedes utilizarlos para guiar a otros usuarios hasta tu ubicación exacta de forma rápida y fiable.</p>"
  },
  "help-02-0": {
    "m": "<h2>¿Qué es un código plus+code?</h2><p>Un código plus+code es un código corto formado por seis o siete letras y números, como <b>$EXAMPLE_CODE$</b>, o combinado con una ciudad o población como este ejemplo: <b>$EXAMPLE_CODE$ Nairobi</b>.</p><p>Estos códigos permiten indicar a otros usuarios una ubicación exacta sin utilizar nombres de calles ni números de edificios.</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      }
  ...
  "help-02-2": {
    "m": "<h2>¿Los códigos plus+code tienen que solicitarse?</h2><p>No, estos códigos ya existen para todas las ubicaciones y son de uso gratuito.</p><p>Para obtener el código plus+code de un lugar, solo tienes que arrastrar el mapa para destacar el lugar en cuestión.</p>"
  },
  "help-03-0": {
    "m": "<h2>¿Cuáles son las partes del código?</h2><p>En el caso de nuestro ejemplo <b>$FULL_CODE$</b>, <b>$CODE_PART_1$</b> es el código de región (100 x 100 kilómetros aproximadamente), <b>$CODE_PART_2$</b> es el código de ciudad (5 x 5 kilómetros) y <b>$CODE_PART_3$</b> es el código de barrio (250 x 250 metros). Después del signo <b>+</b>, <b>$CODE_PART_4$</b> constituye el código de edificio (14 x 14 metros). Puede ir seguido de un código de portal de un solo dígito si el código de tamaño de edificio abarca más de un edificio.</p><p>Normalmente, el código de región no es necesario y, a veces, puede que también tengas que quitar el código de ciudad.</p>",
    "p": {
      "CODE_PART_1": {
        "c": "6GCR"
      },
  ...
  "help-03-1": {
    "m": "<h2>¿Una ubicación tiene más de un código plus+code?</h2><p>No, cada lugar tiene un único código plus+code.</p>"
  },
  "help-03-2": {
    "m": "<h2>¿Puedo guardarlos?</h2><p>Para guardar un código plus+code, solo tienes que crear un marcador de la página. Cuando abras el marcador, te mostrará el lugar en cuestión.</p>"
  },
  "help-03-3": {
    "m": "<h2>¿Puedo utilizar esto cuando no tenga conexión de red?</h2><p>Sí. Una vez que hayas cargado esta página en el teléfono o en el equipo, se guardará una copia y podrás cargarla aunque no tengas conexión de red.</p>"
  },
  "help-03-4": {
    "m": "<h2>¿Puedo obtener indicaciones?</h2><p>Hay un modo de brújula que muestra la dirección en la que debes ir y la distancia hasta el código plus+code desde tu ubicación actual. El menú principal contiene enlaces a varios proveedores de mapas que puedes utilizar.</p>"
  },
  "help-03-5": {
    "m": "<h2>El área de mi código plus+code es demasiado grande.</h2><p>Si aumentas la imagen, el código será para un área más pequeña.</p>"
  },
  "help-03-6": {
    "m": "<h2>La dirección que muestras no es correcta.</h2><p>La dirección indicada solo es una sugerencia, sirve para acortar el código que tienes que utilizar. Puedes probar otras direcciones del cuadro de búsqueda.</p>"
  },
  "input-prompt": {
    "m": "Introduce un código plus+code, una dirección o arrastra el mapa"
  },
  "location-prompt": {
    "m": "Este servicio necesita utilizar tu ubicación. Si el navegador te lo solicita, autorízaselo."
  },
  "map-error": {
    "m": "No se puede cargar Google Maps. Asegúrate de que la red esté operativa e intenta cargar la página de nuevo.<br/><br/>Puedes introducir códigos plus+code con o sin el prefijo y utilizar la brújula, pero no podrás introducir direcciones ni códigos plus+code con direcciones hasta que se muestren los mapas."
  },
  "osm-maps": {
    "m": "Open Street Map"
  },
  ...
  "waiting-for-compass-2": {
    "m": "lectura de la brújula"
  },
  "waiting-location": {
    "m": "Esperando ubicación..."
  }
}
LocalisedMessages["fr"] = {
  ...
  "browser-problem-msg": {
    "m": "Le navigateur que vous utilisez n'est pas compatible avec toutes les fonctionnalités dont nous avons besoin, comme la localisation et la boussole.<br/><br/>Nous vous recommandons de passer à Chrome, Firefox ou Opera."
  },
  "compass-check-fail-msg": {
    "m": "La boussole de votre appareil n'indique pas la direction. Il est possible que la boussole ne soit pas compatible avec votre appareil ou qu'elle ne fonctionne pas correctement."
  },
  "compass-check-msg": {
    "m": "Un problème est peut-être survenu lors de la lecture de la boussole.<br/><br/>Pour la tester, tenez votre appareil à l'horizontale et décrivez un cercle.<br/><br/>Lorsque vous avez fait un tour complet, appuyez sur le bouton ci-dessous."
  },
  "compass-check-ok": {
    "m": "La boussole de votre appareil semble fonctionner !"
  },
  "discuss": {
    "m": "Groupe de discussion"
  },
  "dismiss": {
    "m": "Ignorer"
  },
  "extend-failure-msg": {
    "m": "Pour localiser $OLC$, nous devons connaître votre position ou inclure une ville dans les données. <br/><br/>Vérifiez que le partage de position est autorisé dans votre navigateur et que les services de localisation sont activés sur votre appareil.",
    "p": {
      "OLC": {}
    }
  },
  "feedback-detail": {
    "m": "Envoyez-nous vos commentaires. Dites-nous ce que vous appréciez. Expliquez-nous ce qui fonctionne mal et nous essaierons de l'améliorer."
  },
  "geocode-fail": {
    "m": "Le service d'adresse de Google ne parvient pas à localiser $ADDRESS$.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-not-loaded": {
    "m": "Impossible de localiser $ADDRESS$, car le service d'adresse de Google n'est pas chargé.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-reverse-fail": {
    "m": "Impossible d'obtenir des informations sur la localité (erreur du service de géocodage de Google)."
  },
  "geocoder-no-info": {
    "m": "Le service de géocodage de Google ne dispose pas d'informations de localisation dans cette zone. Vous pouvez essayer d'utiliser un code plus+code contenant le nom d'une grande ville, s'il y en a une dans un rayon de 40 km."
  },
  "google-maps": {
    "m": "Google Maps"
  },
  "help-01-0": {
    "m": "<h2>Votre code postal personnel</h2><p>Les codes plus+code sont des codes courts qui désignent un lieu précis. Vous pouvez utiliser ces codes pour guider d'autres personnes vers votre position exacte, de façon rapide et fiable.</p>"
  },
  "help-02-0": {
    "m": "<h2>Qu'est-ce qu'un code plus+code ?</h2><p>Il s'agit d'un code court composé de six ou sept lettres et chiffres, comme <b>$EXAMPLE_CODE$</b>. Il peut être associé à une ville, par exemple : <b>$EXAMPLE_CODE$ Nairobi</b>.</p><p>Il permet d'indiquer une position exacte, sans recourir aux noms de rues ni aux numéros de bâtiment.</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      }
  ...
  "help-03-1": {
    "m": "<h2>Un lieu peut-il posséder plusieurs codes plus+code ?</h2><p>Non. Un lieu donné ne peut être associé qu'à un seul code plus+code.</p>"
  },
  "help-03-2": {
    "m": "<h2>Puis-je enregistrer les codes ?</h2><p>Pour enregistrer un code plus+code, il vous suffit d'ajouter la page à vos favoris. Le lieu s'affichera lorsque vous ouvrirez la page.</p>"
  },
  "help-03-3": {
    "m": "<h2>Puis-je utiliser cette fonctionnalité lorsque je n'ai pas de réseau ?</h2><p>Oui ! Une fois que vous chargé la page sur votre téléphone ou votre ordinateur, celui-ci en garde une copie à laquelle vous pouvez accéder même hors connexion.</p>"
  },
  "help-03-4": {
    "m": "<h2>Puis-je obtenir un itinéraire ?</h2><p>Un mode boussole vous indique la direction et la distance qui vous sépare du lieu désigné par le code plus+code. Le menu principal contient des liens vers différents fournisseurs de cartes que vous pouvez utiliser.</p>"
  },
  "help-03-5": {
    "m": "<h2>La zone indiquée par mon code plus+code est trop grande !</h2><p>Effectuez un zoom avant pour obtenir un code correspondant à une zone plus réduite.</p>"
  },
  "help-03-6": {
    "m": "<h2>L'adresse affichée est erronée !</h2><p>L'adresse fournie n'est qu'une simple suggestion. Elle sert à réduire la longueur du code que vous devez utiliser. Vous pouvez essayer de saisir d'autres adresses dans le champ de recherche.</p>"
  },
  "input-prompt": {
    "m": "Saisissez un code plus+code, une adresse ou faites glisser la carte"
  },
  "location-prompt": {
    "m": "Ce service doit connaître votre position. Autorisez le partage de votre position si vous y êtes invité par votre navigateur."
  },
  "map-error": {
    "m": "Impossible d'ouvrir Google Maps. Vérifiez que votre réseau fonctionne et réessayez de charger la page.<br/><br/>Tant que Google Maps n'est pas affiché, vous pouvez saisir des codes plus+code avec ou sans code de région, et utiliser la boussole. En revanche, vous ne pouvez pas saisir d'adresses, ni saisir de codes plus+code avec adresse."
  },
  "osm-maps": {
    "m": "Open Street Map"
  },
  ...
  "waiting-for-compass-2": {
    "m": "indication de la boussole"
  },
  "waiting-location": {
    "m": "En attente d'informations de localisation…"
  }
}
LocalisedMessages["hi"] = {
  ...
  "browser-problem-msg": {
    "m": "आप जिस ब्राउज़र का उपयोग कर रहे हैं, वह हमारे लिए आवश्यक सभी सुविधाओं का समर्थन नहीं करता, जैसे स्थान और कंपास.<br/><br/>हम Chrome, Firefox या Opera का उपयोग करने का सुझाव देते हैं."
  },
  "compass-check-fail-msg": {
    "m": "आपके डिवाइस का कंपास दिशा निर्देश की रिपोर्टिंग नहीं कर रहा है. शायद आपका डिवाइस कंपास का समर्थन नहीं कर रहा है या शायद वह यह ठीक से काम नहीं कर रहा है."
  },
  "compass-check-msg": {
    "m": "कंपास को पढ़ने में समस्या हो सकती है.<br/><br/>इसका परीक्षण करने के लिए, अपने डिवाइस को अपने हाथ में समतल स्थिति में पकड़ें और उसे वृत्ताकार तरीके से घुमाएं.<br/><br/>पूरा घुमाने के बाद, नीचे दिए गए बटन पर टैप करें."
  },
  "compass-check-ok": {
    "m": "आपके डिवाइस का कंपास ठीक लग रहा है!"
  },
  "discuss": {
    "m": "चर्चा करें"
  },
  ...
  "extend-failure-msg": {
    "m": "$OLC$ का पता लगाने के लिए, हमें आपके मौजूदा स्थान की आवश्यकता होगी या आपको जानकारी में कोई कस्बा या शहर शामिल करना होगा.<br/><br/>जांच करें कि आपका ब्राउज़र स्थान को अनुमति दे रहा है और आपके डिवाइस पर स्थान सेवाएं सक्षम हैं.",
    "p": {
      "OLC": {}
    }
  },
  "feedback-detail": {
    "m": "फ़ीडबैक भेजें. हमें बताएं कि आप क्या पसंद करते हैं या कौन सी चीज़ें कारगर नहीं हैं और हम उनमें सुधार करने का प्रयास करेंगे."
  },
  "geocode-fail": {
    "m": "Google की पता सेवा $ADDRESS$ का पता नही लगा सकती.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-not-loaded": {
    "m": "Google की पता सेवा लोड नहीं हुई, $ADDRESS$ का पता नहीं लगा सकते.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-reverse-fail": {
    "m": "किसी स्थान की जानकारी नहीं मिली (Google की जियोकोडर सेवा में कोई त्रुटि थी)"
  },
  "geocoder-no-info": {
    "m": "Google की जियोकोडर सेवा के पास इस क्षेत्र की पता जानकारी नहीं है. आप किसी बड़े कस्बे के साथ प्लस+कोड का उपयोग कर सकते हैं, बशर्ते 40किमी के दायरे में कोई बड़ा कस्बा हो."
  },
  "google-maps": {
    "m": "Google मानचित्र"
  },
  "help-01-0": {
    "m": "<h2>आपके अपने पोस्टकोड</h2><p>प्लस+कोड कहीं भी, किसी भी स्थान के संक्षिप्त कोड होते हैं. आप उनका उपयोग करके लोगों को अपने सटीक स्थान पर जल्द और भरोसे के साथ भेजने के लिए मार्गदर्शन कर सकते हैं.</p>"
  },
  "help-02-0": {
    "m": "<h2>प्लस+कोड क्या है?</h2><p>प्लस+कोड छः या सात अक्षरों और संख्याओं के बना एक संक्षिप्त कोड होता है, जैसे <b>$EXAMPLE_CODE$</b>, या वह किसी कस्बे या शहर से संयोजित होता है, जैसे<b>$EXAMPLE_CODE$ नैरोबी</b>.</p><p>वे व्यक्ति को किसी ऐसे स्थान की सटीक जानकारी देते हैं, जो मार्ग के नाम या भवन संख्या पर निर्भर नहीं होता.</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      }
  ...
  "help-02-2": {
    "m": "<h2>क्या मुझे प्लस+कोड के लिए आवेदन करना होगा?</h2><p>नहीं, प्लस+कोड सभी के लिए पहले से उपलब्ध हैं और कोई भी उनका निःशुल्क उपयोग कर सकता है.</p><p>किसी स्थान का प्लस+कोड प्राप्त करने के लिए बस मानचित्र को खींच कर अपना इच्छित स्थान हाइलाइट करें.</p>"
  },
  "help-03-0": {
    "m": "<h2>कोड के विभिन्न हिस्से कौन-कौन से हैं?</h2><p>हमारे उदाहरण कोड के लिए <b>$FULL_CODE$</b>, <b>$CODE_PART_1$</b> क्षेत्र कोड है (लगभग 100 x 100 किलोमीटर). <b>$CODE_PART_2$</b> शहर कोड है (5 x 5 किलोमीटर). <b>$CODE_PART_3$</b> पड़ोस का कोड है (250 x 250 मीटर). <b>+</b> के बाद, <b>$CODE_PART_4$</b> भवन का कोड है (14 x 14 मीटर). यदि भवन आकार कोड एक से अधिक भवनों से बढ़ जाता है तो उसके बाद एकल अंक का डोर कोड डाला जा सकता है. </p><p>आमतौर पर, क्षेत्र कोड की आवश्यकता नहीं पड़ती और कभी-कभी आप शहर कोड को भी छोड़ सकते हैं.</p>",
    "p": {
      "CODE_PART_1": {
        "c": "6GCR"
      },
  ...
  "help-03-1": {
    "m": "<h2>क्या किसी स्थान पर एक से अधिक प्लस+कोड हैं?</h2><p>नहीं. हर स्थान पर केवल एक प्लस+कोड है.</p>"
  },
  "help-03-2": {
    "m": "<h2>क्या मैं उन्हें सहेज सकता/सकती हूं?</h2><p>किसी प्लस+कोड को सहेजने के लिए, बस उस पृष्ठ का बुकमार्क बनाएं. जब आप बुकमार्क खोलेंगे, तो वह आपको वह स्थान दर्शाएगा.</p>"
  },
  "help-03-3": {
    "m": "<h2>क्या मैं इसे नेटवर्क के बिना उपयोग कर सकता/सकती हूं?</h2><p>हां! जब आप अपने फ़ोन या कंप्यूटर पर इस पृष्ठ को लोड कर लेंगे, तो यह उसकी एक कॉपी बना लेगा और फिर आप किसी नेटवर्क कनेक्शन के बिना भी उसे लोड कर सकेंगे.</p>"
  },
  "help-03-4": {
    "m": "<h2>क्या मुझे दिशा निर्देश प्राप्त हो सकते हैं?</h2><p>एक कंपास मोड आपके स्थान से मौजूदा प्लस+कोड तक पहुंचने की दिशा और दूरी की जानकारी प्रदान करता है. मुख्य मेनू में विभिन्न मानचित्र प्रदाताओं के लिंक होते हैं, जिन्हें आप उपयोग कर सकते हैं.</p>"
  },
  "help-03-5": {
    "m": "<h2>मेरा प्लस+कोड क्षेत्र बहुत बड़ा है!</h2><p>यदि आप ज़ूम और बढ़ाते हैं तो कोड अपेक्षाकृत एक छोटा क्षेत्र दर्शाएगा.</p>"
  },
  "help-03-6": {
    "m": "<h2>आपने जो पता दिखाया है, वह गलत है!</h2><p>दिया गया पता केवल एक सुझाव है. इसका उपयोग आपके द्वारा उपयोग किए जाने वाले कोड की लंबाई कम करने के लिए किया जाता है. आप खोज बॉक्स में अन्य पते आज़मा सकते हैं.</p>"
  },
  "input-prompt": {
    "m": "कोई प्लस+कोड, पता डालें या मानचित्र खींचें"
  },
  "location-prompt": {
    "m": "यह सेवा आपके स्थान का उपयोग करती है. यदि आपका ब्राउज़र पूछे तो कृपया इसे अनुमति दें."
  },
  "map-error": {
    "m": "Google मानचित्र लोड नहीं कर सकते. सुनिश्चित करें कि आपका नेटवर्क कार्य कर रहा है और पृष्ठ पुनः लोड करें.<br/><br/>आप क्षेत्र कोड के साथ या उसके बिना प्लस+कोड डाल सकते हैं और कंपास का उपयोग कर सकते हैं, लेकिन आप मानचित्रों के प्रदर्शित होने तक पते या पतों के साथ प्लस+कोड नहीं डाल पाएंगे."
  },
  "osm-maps": {
    "m": "ओपन स्ट्रीट मानचित्र"
  },
  "ui-feedback": {
    "m": "फ़ीडबैक"
  },
  ...
  "waiting-for-compass-1": {
    "m": "इसकी प्रतीक्षा करें"
  },
  "waiting-for-compass-2": {
    "m": "कंपास रीडिंग"
  },
  "waiting-location": {
    "m": "स्थान की प्रतीक्षा की जा रही है..."
  }
}
LocalisedMessages["id"] = {
  ...
  "browser-problem-msg": {
    "m": "Browser yang Anda gunakan tidak mendukung semua fitur yang kami butuhkan, seperti lokasi dan kompas.<br/><br/>Sebaiknya gunakan Chrome, Firefox, atau Opera."
  },
  "compass-check-fail-msg": {
    "m": "Kompas pada perangkat Anda tidak melaporkan arah. Kompas mungkin tidak didukung oleh perangkat Anda, atau mungkin tidak berfungsi dengan baik."
  },
  "compass-check-msg": {
    "m": "Mungkin terjadi masalah dalam membaca kompas.<br/><br/>Untuk mengujinya, pegang perangkat dalam posisi datar dan putar membentuk lingkaran.<br/><br/>Setelah memutar penuh, ketuk tombol di bawah."
  },
  "compass-check-ok": {
    "m": "Kompas pada perangkat Anda tampak tidak bermasalah!"
  },
  "discuss": {
    "m": "Diskusikan"
  },
  ...
  "extend-failure-msg": {
    "m": "Untuk mencari tahu lokasi $OLC$, kami perlu mengetahui lokasi Anda saat ini, atau Anda harus mencantumkan kota pada informasi.<br/><br/>Pastikan browser Anda mengizinkan lokasi, dan layanan lokasi diaktifkan pada perangkat Anda.",
    "p": {
      "OLC": {}
    }
  },
  "feedback-detail": {
    "m": "Kirim masukan. Beri tahu kami apa yang Anda suka, atau apa yang tidak berfungsi dan kami akan berusaha untuk memperbaikinya."
  },
  "geocode-fail": {
    "m": "Layanan alamat Google tidak dapat menemukan $ADDRESS$.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-not-loaded": {
    "m": "Layanan alamat Google tidak dimuat, tidak dapat menemukan $ADDRESS$.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-reverse-fail": {
    "m": "Tidak bisa mendapatkan informasi lokalitas (terdapat kesalahan pada layanan geocoder Google)"
  },
  "geocoder-no-info": {
    "m": "Layanan geocoder Google tidak memiliki informasi alamat di area ini. Anda mungkin dapat menggunakan plus+code dengan nama kota besar, jika ada kota dalam jarak 40 km."
  },
  "google-maps": {
    "m": "Google Maps"
  },
  "help-01-0": {
    "m": "<h2>Kode pos pribadi Anda</h2><p>plus+code merupakan kode singkat untuk setiap lokasi, di mana pun. Anda dapat menggunakannya untuk memandu orang ke lokasi tepat Anda, dengan cepat dan dapat diandalkan.</p>"
  },
  "help-02-0": {
    "m": "<h2>Apa itu plus+code?</h2><p>Plus+code merupakan kode singkat yang terdiri dari 6 atau 7 huruf dan angka, seperti <b>$EXAMPLE_CODE$</b>, atau dikombinasikan dengan kota seperti ini <b>$EXAMPLE_CODE$ Nairobi</b>.</p><p>Dengan ini, Anda dapat memberi seseorang lokasi yang tepat yang tidak bergantung pada nama jalan atau nomor gedung.</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      }
  ...
  "help-02-2": {
    "m": "<h2>Apakah saya perlu mengajukan permohonan untuk mendapatkan plus+code?</h2><p>Tidak, plus+code sudah ada di mana-mana dan setiap orang dapat menggunakannya secara gratis.</p><p>Untuk mendapatkan plus+code suatu tempat, cukup seret peta untuk menyoroti tempat yang Anda inginkan.</p>"
  },
  "help-03-0": {
    "m": "<h2>Apa saja bagian dari kode?</h2><p>Untuk contoh kode kami <b>$FULL_CODE$</b>, <b>$CODE_PART_1$</b> adalah kode wilayah (kira-kira 100 x 100 kilometer). <b>$CODE_PART_2$</b> adalah kode kota (5 x 5 kilometer). <b>$CODE_PART_3$</b> adalah kode lingkungan (250 x 250 meter). Setelah <b>+</b>, <b>$CODE_PART_4$</b> adalah kode gedung (14 x 14 meter). Kode ini dapat diikuti dengan satu digit kode pintu, apabila kode ukuran gedung diperpanjang lebih dari satu gedung.</p><p>Biasanya, kode wilayah tidak diperlukan, dan terkadang Anda juga dapat meletakkan kode kota.</p>",
    "p": {
      "CODE_PART_1": {
        "c": "6GCR"
      },
  ...
  "help-03-1": {
    "m": "<h2>Apakah lokasi memiliki lebih dari satu plus+code?</h2><p>Tidak. Setiap tempat hanya memiliki satu plus+code.</p>"
  },
  "help-03-2": {
    "m": "<h2>Dapatkah disimpan?</h2><p>Untuk menyimpan plus+code, cukup buat bookmark untuk laman tersebut. Ketika Anda membuka bookmark, tempat akan ditunjukkan.</p>"
  },
  "help-03-3": {
    "m": "<h2>Dapatkah saya menggunakannya pada saat tidak tersambung ke jaringan?</h2><p>Ya! Setelah laman ini dimuat pada ponsel atau komputer Anda, salinan akan disimpan dan Anda dapat memuatnya tanpa harus tersambung ke jaringan internet.</p>"
  },
  "help-03-4": {
    "m": "<h2>Bisakah saya mendapatkan petunjuk arah?</h2><p>Terdapat mode kompas yang menunjukkan arah dan jarak dari posisi Anda ke plus+code saat ini. Menu utama memiliki tautan ke berbagai penyedia peta yang dapat Anda gunakan.</p>"
  },
  "help-03-5": {
    "m": "<h2>Area plus+code saya terlalu besar!</h2><p>Jika Anda memperbesar lebih lanjut, kode akan ditujukan untuk area yang lebih kecil.</p>"
  },
  "help-03-6": {
    "m": "<h2>Alamat yang Anda tunjukkan salah!</h2><p>Alamat yang diberikan hanya saran. Ini digunakan untuk mengurangi panjang kode yang perlu digunakan. Anda dapat mencoba alamat lain di kotak telusur.</p>"
  },
  "input-prompt": {
    "m": "Masukkan plus+code, alamat, atau seret peta"
  },
  "location-prompt": {
    "m": "Layanan ini perlu menggunakan lokasi Anda. Jika browser meminta, izinkan."
  },
  "map-error": {
    "m": "Google Maps tidak dapat dimuat. Pastikan jaringan Anda berfungsi dan coba muat ulang laman.<br/><br/>Anda dapat memasukkan plus+code dengan atau tanpa kode area, dan menggunakan kompas, namun Anda tidak dapat memasukkan alamat, atau plus+code dengan alamat, sampai peta ditampilkan."
  },
  "osm-maps": {
    "m": "Open Street Map"
  },
...
LocalisedMessages["pt-BR"] = {
  ...
  "browser-problem-msg": {
    "m": "O navegador que você está usando não suporta todos os recursos necessários, como local e bússola.<br/><br/>Recomendamos o uso do Chrome, Firefox ou Opera."
  },
  "compass-check-fail-msg": {
    "m": "A bússola do seu dispositivo não está indicando a direção. Não há suporte para a bússola no seu dispositivo ou ela não está funcionando corretamente."
  },
  "compass-check-msg": {
    "m": "Pode haver um problema na bússola.<br/><br/>Para testá-la, mantenha seu dispositivo na horizontal e gire seu corpo 360° no próprio eixo.<br/><br/>Quando terminar a volta, toque no botão abaixo."
  },
  "compass-check-ok": {
    "m": "A bússola do seu dispositivo parece estar funcionando."
  },
  "discuss": {
    "m": "Discussão"
  },
  ...
  "extend-failure-msg": {
    "m": "Para identificar onde $OLC$ fica, precisamos do seu local atual ou você precisa incluir uma cidade na informação.<br/><br/>Verifique se seu navegador permite a localização e se os serviços de localização estão ativados no seu dispositivo.",
    "p": {
      "OLC": {}
    }
  },
  "feedback-detail": {
    "m": "Envie comentários. Conte-nos do que você gosta ou o que não funciona bem e tentaremos melhorar."
  },
  "geocode-fail": {
    "m": "O serviço de endereços do Google não conseguiu localizar $ADDRESS$.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-not-loaded": {
    "m": "O serviço de endereços do Google não foi carregado, não é possível localizar $ADDRESS$.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-reverse-fail": {
    "m": "Não foi possível obter informações da localidade (erro no serviço de geocódigos do Google)"
  },
  "geocoder-no-info": {
    "m": "O serviço de geocódigos do Google não tem informações de endereço nessa área. Você pode usar um código plus+ com o nome de uma cidade grande se houver uma no raio de 40 km"
  },
  "google-maps": {
    "m": "Google Maps"
  },
  "help-01-0": {
    "m": "<h2>Seu próprio código postal pessoal</h2><p>Os códigos plus+ são códigos curtos para qualquer local, em todos os lugares. Use-os para guiar as pessoas até sua localização exata de forma rápida e confiável.</p>"
  },
  "help-02-0": {
    "m": "<h2>O que é um código plus+?</h2><p>O código plus+ é um código curto composto de seis ou sete letras e números, como <b>$EXAMPLE_CODE$</b>, ou combinado com uma cidade, como este <b>$EXAMPLE_CODE$ Nairobi</b>.</p><p>Com eles, você fornece a alguém um local exato que não depende de nomes de rua ou de números de prédios.</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      }
  ...
  "help-02-2": {
    "m": "<h2>Eu preciso solicitar um código plus+?</h2><p>Não, os códigos plus+ já existem em qualquer lugar e todos podem usá-los de graça.</p><p>Para ver o código plus+ de um lugar, basta arrastar o mapa para destacar o local desejado.</p>"
  },
  "help-03-0": {
  ...
  "help-03-1": {
    "m": "<h2>Um local tem mais de um código plus+?</h2><p>Não. Todos os locais têm apenas um código plus+.</p>"
  },
  "help-03-2": {
    "m": "<h2>Posso salvá-los?</h2><p>Para salvar um código plus+, basta adicionar a página aos favoritos. O local será exibido quando você abrir o favorito.</p>"
  },
  "help-03-3": {
    "m": "<h2>Posso usar esse recurso quando não há rede?</h2><p>Sim. Depois que você carrega essa página no seu telefone ou computador, ele mantém uma cópia e permite que ela seja carregada mesmo sem uma conexão de rede.</p>"
  },
  "help-03-4": {
    "m": "<h2>Posso ver a rota?</h2><p>Há um modo de bússola que mostra a rota e a distância de onde você está até o código plus+ atual. No menu principal, você encontra links para provedores de mapas diferentes disponíveis para usar.</p>"
  },
  "help-03-5": {
    "m": "<h2>Minha área do código plus+ é muito grande.</h2><p> Se você aumentar o zoom, o código será para uma área menor.</p>"
  },
  "help-03-6": {
    "m": "<h2>O endereço que você mostrou está errado.</h2><p>O endereço fornecido é apenas uma sugestão. Ele é usado para reduzir o comprimento do código que você precisa usar. Tente inserir outros endereços na caixa de pesquisa.</p>"
  },
  "input-prompt": {
    "m": "Insira um código plus+, um endereço ou arraste o mapa"
  },
  "location-prompt": {
    "m": "Este serviço precisa usar seu local. Dê permissão caso seja solicitado pelo navegador."
  },
  "map-error": {
    "m": "Não foi possível carregar o Google Maps. Verifique se a rede está funcionando e tente recarregar a página.<br/><br/>Insira os códigos plus+ com ou sem o código de área e use a bússola. No entanto, você só poderá inserir endereços ou códigos plus+ com endereços quando os mapas forem exibidos."
  },
  "osm-maps": {
    "m": "Abrir mapa da rua"
  },
...
LocalisedMessages["pt"] = {
  ...
  "browser-problem-msg": {
    "m": "O navegador utilizado não suporta todas as funcionalidades de que precisamos, como a localização e a bússola.<br/><br/>Recomendamos a utilização do Chrome, do Firefox ou do Opera."
  },
  "compass-check-fail-msg": {
    "m": "A bússola do seu dispositivo não está a indicar a direção. É possível que o dispositivo não suporte a bússola ou que esta não esteja a funcionar corretamente."
  },
  "compass-check-msg": {
    "m": "Poderá ocorrer um problema com a leitura da bússola.<br/><br/>Para testá-la, segure o dispositivo na horizontal e rode-o perfazendo um círculo.<br/><br/>Após rodá-lo completamente, toque no botão abaixo."
  },
  "compass-check-ok": {
    "m": "A bússola do seu dispositivo parece estar a funcionar."
  },
  "discuss": {
    "m": "Discutir"
  },
  ...
  "extend-failure-msg": {
    "m": "Para determinar onde fica $OLC$, precisamos que nos forneça a sua localização atual ou que inclua uma localidade ou cidade nas informações.<br/><br/>Confirme se o seu navegador está a permitir o acesso à localização e se os serviços de localização estão ativados no seu dispositivo.",
    "p": {
      "OLC": {}
    }
  },
  "feedback-detail": {
    "m": "Envie comentários. Diga-nos do que gosta e o que não está a funcionar, para tentarmos melhorar esses aspetos."
  },
  "geocode-fail": {
    "m": "O serviço de endereços da Google não consegue localizar $ADDRESS$.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-not-loaded": {
    "m": "O serviço de endereços da Google não foi carregado, pelo que não é possível localizar $ADDRESS$.",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-reverse-fail": {
    "m": "Não foi possível obter informações de localidade (ocorreu um erro com o serviço geocodificador da Google)"
  },
  "geocoder-no-info": {
    "m": "O serviço geocodificador da Google não possui informações de endereço nesta área. Poderá conseguir utilizar um código+ com o nome de uma cidade grande, se houver uma num raio de 40 km."
  },
  "google-maps": {
    "m": "Google Maps"
  },
  "help-01-0": {
    "m": "<h2>Os seus códigos+ de código postal pessoais</h2><p> são códigos curtos para qualquer localização, em qualquer lugar. Pode utilizá-los para ajudar as pessoas a encontrarem a sua localização exata de uma forma rápida e fiável.</p>"
  },
  "help-02-0": {
    "m": "<h2>O que é um código+?</h2><p>Um código+ é um código curto composto por seis ou sete letras e números, como <b>$EXAMPLE_CODE$</b>, ou com uma combinação de uma localidade ou cidade como <b>$EXAMPLE_CODE$ Nairobi</b>.</p><p>Este código permite-lhe dar a alguém uma localização exata que não depende de nomes de rua ou números de edifícios.</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      }
  ...
  "help-02-2": {
    "m": "<h2>Preciso de me candidatar à obtenção de um código+?</h2><p>Não, os códigos+ já estão disponíveis e qualquer pessoa pode utilizá-los gratuitamente.</p><p>Para obter o código+ para um local, basta arrastar o mapa para realçar o local pretendido.</p>"
  },
  "help-03-0": {
  ...
  "help-03-1": {
    "m": "<h2>Uma localização pode ter mais de um código+?</h2><p>Não. Qualquer local tem apenas um código+.</p>"
  },
  "help-03-2": {
    "m": "<h2>Posso guardá-lo?</h2><p>Para guardar um código+, basta criar um marcador para a página. Quando abrir o marcador, este vai mostrar o local.</p>"
  },
  "help-03-3": {
    "m": "<h2>Posso utilizá-lo quando não tiver rede?</h2><p>Sim. Após carregar esta página no seu telemóvel ou no computador, é criada uma cópia da página, a qual vai poder carregar mesmo que não tenha ligação à rede.</p>"
  },
  "help-03-4": {
    "m": "<h2>Posso obter direções?</h2><p>Existe um modo de bússola que lhe mostra a direção e a distância de onde está em relação ao código+ atual. O menu principal tem links para os diferentes fornecedores de mapas que pode utilizar.</p>"
  },
  "help-03-5": {
    "m": "<h2>A área do meu código+ é demasiado grande.</h2><p>Se aumentar mais o zoom, a área do código fica mais pequena.</p>"
  },
  "help-03-6": {
    "m": "<h2>O endereço mostrado está errado.</h2><p>O endereço fornecido é apenas uma sugestão. É utilizado para reduzir o comprimento do código que precisa de utilizar. Pode experimentar outros endereços na caixa de pesquisa.</p>"
  },
  "input-prompt": {
    "m": "Introduza um código+, um endereço ou arraste o mapa"
  },
  "location-prompt": {
    "m": "Este serviço precisa de utilizar a sua localização. Se o navegador lhe pedir acesso, autorize-o."
  },
  "map-error": {
    "m": "Não é possível carregar o Google Maps. Certifique-se de que tem uma rede a funcionar e experimente atualizar a página.<br/><br/>Pode introduzir os códigos+ com ou sem o indicativo e utilizar a bússola, mas só vai conseguir introduzir endereços ou códigos+ com endereços quando forem apresentados mapas."
  },
  "osm-maps": {
    "m": "Open Street Map"
  },
...
LocalisedMessages["ru"] = {
  ...
  "browser-problem-msg": {
    "m": "В вашем браузере не поддерживаются некоторые функции, такие как геолокация и компас.<br/><br/>Рекомендуем использовать Chrome, Firefox или Opera."
  },
  "compass-check-fail-msg": {
    "m": "Ваше устройство не передает данные о направлении. Возможно, компас на нем не установлен или работает некорректно."
  },
  "compass-check-msg": {
    "m": "Не удалось прочитать данные компаса.<br/><br/>Чтобы проверить его, разместите устройство горизонтально и поверните его по кругу.<br/><br/>Описав полный круг, нажмите кнопку ниже."
  },
  "compass-check-ok": {
    "m": "Компас на вашем устройстве работает корректно."
  },
  "discuss": {
    "m": "Форум"
  },
  ...
  "extend-failure-msg": {
    "m": "Чтобы можно было определить, где находится объект \"$OLC$\", укажите город или предоставьте доступ к информации о вашем местоположении.<br/><br/>Убедитесь, что в вашем браузере разрешен этот доступ и на устройстве включена геолокация.",
    "p": {
      "OLC": {}
    }
  },
  "feedback-detail": {
    "m": "Расскажите нам, что вам нравится, а что требует доработки. Мы учтем ваши замечания."
  },
  "geocode-fail": {
    "m": "Не удается найти адрес \"$ADDRESS$\".",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-not-loaded": {
    "m": "Служба геолокации Google не загружена. Не удается найти адрес \"$ADDRESS$\".",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-reverse-fail": {
    "m": "Не удалось получить информацию о местоположении (произошла ошибка службы геокодирования Google)."
  },
  "geocoder-no-info": {
    "m": "В службе геокодирования Google нет информации об адресах из этой области. Если на расстоянии 40 км от вас есть большой город, используйте +код с его названием."
  },
  "google-maps": {
    "m": "Google Карты"
  },
  "help-01-0": {
    "m": "<h2>Ваш персональный индекс</h2><p>+Код – это короткий номер, присвоенный каждому местоположению. Он дает возможность с легкостью передавать другим пользователям точную информацию о каком-либо месте.</p>"
  },
  "help-02-0": {
    "m": "<h2>Что такое +код?</h2><p>Это небольшой фрагмент, состоящий из 6–7 букв или цифр, например <b>$EXAMPLE_CODE$</b>. Он также может указываться вместе с названием города: <b>$EXAMPLE_CODE$ Найроби</b>.</p><p>Этот код позволяет передавать точную информацию о местоположении без привязки к названию улицы или номеру дома.</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      }
  ...
  "help-02-2": {
    "m": "<h2>Нужно ли запрашивать +код?</h2><p>Нет. +Коды присвоены всем местоположениям и могут бесплатно использоваться любым участником.</p><p>Чтобы получить +код, выделите нужное место, перетащив карту.</p>"
  },
  "help-03-0": {
    "m": "<h2>Какая информация указывается в коде?</h2><p>Рассмотрим пример кода: <b>$FULL_CODE$</b>. <b>$CODE_PART_1$</b> – код региона (примерно 100 x 100 км). <b>$CODE_PART_2$</b> – код города (5 x 5 км). <b>$CODE_PART_3$</b> – код микрорайона (250 x 250 м). После знака <b>+</b> указывается код дома – <b>$CODE_PART_4$</b> (14 x 14 м). Если код относится к нескольким зданиям, в конце может стоять код входа, состоящий из одной цифры.</p><p>Код региона, как правило, можно не указывать. Иногда можно обойтись и без кода города.</p>",
    "p": {
      "CODE_PART_1": {
        "c": "6GCR"
      },
  ...
  "help-03-1": {
    "m": "<h2>Может ли местоположение иметь несколько +кодов?</h2><p>Нет. Каждому местоположению присваивается только один +код.</p>"
  },
  "help-03-2": {
    "m": "<h2>Можно ли сохранить +код?</h2><p>Да. Нужно лишь добавить страницу в закладки, и вы всегда сможете просмотреть это место.</p>"
  },
  "help-03-3": {
    "m": "<h2>Можно ли просмотреть местоположение в офлайн-режиме?</h2><p>Да. После загрузки этой страницы на ваш телефон или компьютер создается копия, которую можно загружать и без подключения к сети.</p>"
  },
  "help-03-4": {
    "m": "<h2>Как проложить маршрут?</h2><p>Вы можете использовать режим компаса, чтобы узнать направление к месту с указанным +кодом и расстояние до него. В главном меню вы найдете ссылки на разные картографические сервисы.</p>"
  },
  "help-03-5": {
    "m": "<h2>+Коду соответствует слишком большая область!</h2><p>Если вы увеличите масштаб, область, соответствующая коду, уменьшится.</p>"
  },
  "help-03-6": {
    "m": "<h2>Показанный адрес неверен!</h2><p>Предложенный адрес может быть неточным. Он используется для сокращения длины кода. Попробуйте указать другой вариант в окне поиска.</p>"
  },
  "input-prompt": {
    "m": "Укажите +код или адрес либо перетащите карту"
  },
  "location-prompt": {
    "m": "Для этого сервиса требуется информация о вашем местоположении. Если браузер запрашивает ее, дайте разрешение."
  },
  "map-error": {
    "m": "Не удается загрузить Google Карты. Проверьте доступ к сети и перезагрузите страницу.<br/><br/>Вы можете указывать +коды с кодами областей или без них и использовать компас, однако вы не сможете указывать адреса и +коды с адресами, пока не отобразятся карты."
  },
  "osm-maps": {
    "m": "Open Street Map"
  },
...
LocalisedMessages["ur"] = {
  ...
  "browser-problem-msg": {
    "m": "آپ جو براؤزر استہمال کر رہے ہیں، وہ ہمارے لئے ضروری تمام خصوصیات کا تعاون نہیں کرتا، جیسے مقام اور قطب نما۔<br/><br/>ہم Chrome، Firefox، یا Opera کا استعمال کرنے کا مشورہ دیتے ہیں۔"
  },
  "compass-check-fail-msg": {
    "m": "آپ کے آلے کا قطب نما سمت کی اطلاع نہیں دے رہا ہے۔ عین ممکن ہے کہ آپ کا آلہ قطب نما کا تعاون نہ کر رہا ہو یا وہ اچھی طرح کام نہ کر رہا ہو۔"
  },
  "compass-check-msg": {
    "m": "قطب نما کو پڑھنے میں مسئلہ پیش آ سکتا ہے۔<br/><br/>اس کی جانچ کرنے کے لئے، اپنے آلے کو مسطح انداز میں پکڑیں اور اسے دائرے میں گھمائیں۔<br/><br/>مکمل طور پر گھمانے کے بعد، نیچے دیے گئے بٹن کو تھپتھپائیں۔"
  },
  "compass-check-ok": {
    "m": "آپ کے آلے کا قطب نما ٹھیک لگ رہا ہے!"
  },
  "discuss": {
    "m": "بحث کریں"
  },
  ...
  "extend-failure-msg": {
    "m": "$OLC$ کا پتہ لگانے کے لئے، ہمیں آپ کے موجودہ مقام کی ضرورت ہوگی، یا آپ کو معلومات میں کوئی قصبہ یا شہر شامل کرنا ہوگا۔ <br/><br/>جانچ کرلیں کہ آپ کا براؤزر مقام کو اجازت دے رہا ہے، اور مقام کی وہ سروسز آپ کے آلے پر فعال ہیں۔",
    "p": {
      "OLC": {}
    }
  },
  "feedback-detail": {
    "m": "تاثرات بھیجیں۔ ہمیں بتائیں کہ آپ کیا پسند کرتے ہیں یا کون سی چیز کارگر نہیں ہے اور ہم انہیں بہتر بنانے کی کوشش کریں گے۔"
  },
  "geocode-fail": {
    "m": "Google پتہ سروس $ADDRESS$ تلاش نہیں کر ستکا۔",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-not-loaded": {
    "m": "Google پتہ سروس لوڈ نہیں ہے، $ADDRESS$ تلاش نہیں کر سکتا۔",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-reverse-fail": {
    "m": "کوئی بھی علاقائی معلومات حاصل نہیں کر سکا (Google کی جیو کوڈر سروس میں ایک خرابی تھی)"
  },
  "geocoder-no-info": {
    "m": "Google کی جیو کوڈر سروس کے پاس اس علاقے کے پتے کی معلومات نہیں ہے۔ آپ کسی بڑے قصبے کے نام کے ساتھ پلس+کوڈ کا استعمال کر سکتے ہیں، بشرطیکہ 40 کلومیٹر کے دائرے میں کوئی بڑا قصبہ موجود ہو۔"
  },
  "google-maps": {
    "m": "Google Maps"
  },
  "help-01-0": {
    "m": "<h2>آپ کا ذاتی پوسٹ کوڈ</h2><p>پلس+کوڈ کہیں بھی، کسی بھی جگہ کے مختصر کوڈ ہیں۔ آپ ان کا استعمال کر کے لوگوں کی اپنے قطعی مقام کی جانب جلد اور اعتماد کےساتھ رہنمائی کر سکتے ہیں۔</p>"
  },
  "help-02-0": {
    "m": "<h2>پلس+کوڈ کیا ہے؟</h2><p>پلس+کوڈ چھ یا سات حروف اور اعداد سے بنا ایک مختصر کوڈ ہے، جیسے <b>$EXAMPLE_CODE$</b>، یا وہ کسی قصبے یا شہر کے ساتھ مشترک ہوتا ہے، جیسے <b>$EXAMPLE_CODE$نیروبی</b>۔</p><p>وہ آپ کو کسی ایسے مقام کی قطعی اطلاع دیتے ہیں جو سڑک کے ناموں یا عمارت کی تعداد پر منحصر نہیں ہوتا ہے۔</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      }
  ...
  "help-02-2": {
    "m": "<h2>کیا مجھے پلس+کوڈ کے لئے درخواست دینی ہوگی؟</h2><p>نہیں، پلس+کوڈ پہلے ہی ہر جگہ موجود ہیں اور کوئی بھی ان کا مفت استعمال کر سکتا ہے۔</p><p>کسی جگہ کے لئے پلس+کوڈ حاصل کرنے کے لئے صرف نقشے کو کھینچ کر اپنا پسندیدہ جگہ کو نمایاں کریں۔</p>"
  },
  "help-03-0": {
  ...
  "help-03-1": {
    "m": "<h2>کیا کسی مقام میں ایک سے زیادہ پلس+کوڈ ہے؟</h2><p>نہیں۔ ہر مقام پر صرف ایک پلس+کوڈ ہے۔</p>"
  },
  "help-03-2": {
    "m": "<h2>کیا میں انہیں محفوظ کر سکتا ہوں؟</h2><p>کسی پلس+کوڈ کو محفوظ کرنے کے لئے، صرف اس صفحے کا بُک مارک بنائیں۔ جب آپ بُک مارک کھولیں گے، تو وہ آپ کو وہ جگہ دکھائے گا۔</p>"
  },
  "help-03-3": {
    "m": "<h2>کیا میں نیٹ ورک کے بغیر اس کا استعمال کر سکتا ہوں؟</h2><p>ہاں! جب آپ اس صفحے کو اپنے فون یا کمپیوٹر پر لوڈ کر لیں گے، تو یہ اس کی ایک کاپی بنا لے گا اور پھر آپ کسی نیٹ ورک کنکشن کے بغیر بھی اسے لوڈ کر سکیں گے۔</p>"
  },
  "help-03-4": {
    "m": "<h2>کیا میں ڈائریکشنز حاصل کر سکتا ہوں؟</h2><p>ایک قطب نما موڈ آپ کے مقام سے موجودہ پلس+کوڈ تک پہنچنے کے سمت اور فاصلے کی معلومات فراہم کرتا ہے۔ مرکزی مینو میں مختلف نقشہ فراہم کنندگان کے لنکس ہوتے ہیں، جنہیں آپ استعمال کر سکتے ہیں۔</p>"
  },
  "help-03-5": {
    "m": "<h2>میرا پلس+کوڈ علاقہ بہت بڑا ہے!</h2><p>اگر آپ مزید زوم ان کرتے ہیں، تو کوڈ ایک نسبتاً چھوٹے علاقے کے لئے ہو جائے گا۔</p>"
  },
  "help-03-6": {
    "m": "<h2>آپ نے جو پتہ دکھایا ہے، وہ غلط ہے!</h2><p>دیا گیا پتہ صرف ایک تجویز ہے۔ اس کا استعمال آپ کے ذریعے استعمال کئے جانے والے کوڈ کی لمبائی کم کرنے کے لئے کیا جاتا ہے۔ آپ کو استعمال کرنی ہوگی۔ آپ تلاش کے خانے میں دیگر پتے آزما سکتے ہیں۔</p>"
  },
  "input-prompt": {
    "m": "کوئی پلس+کوڈ، پتہ درج کریں یا نقشہ کھینچیں"
  },
  "location-prompt": {
    "m": "اس سروس کو آپ کا مقام استعمال کرنے کی ضرورت ہے۔ اگر آپ کا براؤزر پوچھتا ہے، تو براہ کرم اسے اجازت دیں۔"
  },
  "map-error": {
    "m": "Google Maps لوڈ نہیں کر سکتے۔ یقینی بنائیں کہ آپ کا نیٹ ورک کام کر رہا ہے اور صفحے کو دوبارہ لوڈ کرنے کی کوشش کریں۔<br/><br/>آپ علاقے کے کوڈ کے ساتھ یا اس کے بغیر پلس+کوڈ درج کر سکتے ہیں، اور قطب نما کا استعمال کر سکتے ہیں، لیکن آپ نقشوں کو دکھائے جانے کا عمل جاری رہنے پتے، یا پتوں کے ساتھ پلس+کوڈ درج نہیں کر پائیں گے۔"
  },
  "osm-maps": {
    "m": "اوپن اسٹریٹ نقشہ"
  },
...
LocalisedMessages["zh"] = {
  ...
  "browser-problem-msg": {
    "m": "您使用的浏览器无法支持我们需要的全部功能，例如位置信息和罗盘。<br/><br/>我们建议您使用 Chrome、Firefox 或 Opera 浏览器。"
  },
  "compass-check-fail-msg": {
    "m": "您设备上的罗盘并未报告方向。您的设备可能不支持此罗盘，或者罗盘的运行不正常。"
  },
  "compass-check-msg": {
    "m": "读取罗盘时可能出现了问题。<br/><br/>要测试其是否正常，请将设备拿稳放平并转一个圈。<br/><br/>转完一整圈后，请点按下面的按钮。"
  },
  "compass-check-ok": {
    "m": "您设备上的罗盘看起来正常！"
  },
  ...
  "extend-failure-msg": {
    "m": "为获取$OLC$的位置，我们需要使用您当前的位置信息，或者您可以在信息中加入城镇或城市。<br/><br/>请确保您的浏览器允许使用位置信息，而且您的设备启用了位置信息服务。",
    "p": {
      "OLC": {}
    }
  },
  "feedback-detail": {
    "m": "发送反馈意见。请告诉我们您喜欢哪些功能或者哪些功能还存在问题，我们将会做出相应的改进。"
  },
  "geocode-fail": {
    "m": "Google 的地址服务无法定位$ADDRESS$。",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-not-loaded": {
    "m": "Google 的地址服务未加载，无法定位$ADDRESS$。",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-reverse-fail": {
    "m": "无法获取任何位置信息（Google 的地理编码服务出现错误）"
  },
  "geocoder-no-info": {
    "m": "Google 的地理编码服务没有此区域的地址信息。如果方圆 40 公里之内有大城镇，那么您可以使用包含城镇名称的 plus+code。"
  },
  "google-maps": {
    "m": "Google 地图"
  },
  "help-01-0": {
    "m": "<h2>您的私人邮政编码</h2><p>plus+code 是一小段代码，可以代表任何地方、任何位置。借助这些代码，您可以快速、可靠地将他人引导至确切的位置。</p>"
  },
  "help-02-0": {
    "m": "<h2>什么是 plus+code？</h2><p>plus+code 是由 6 个或 7 个字母和数字组成的一小段代码（例如 <b>$EXAMPLE_CODE$</b>），或者是包含城镇或城市名称的代码组合（例如<b>$EXAMPLE_CODE$ Nairobi</b>）。</p><p>使用这样的代码，您无需依赖街道名称或建筑物名称即可向他人提供准确的地址。</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      }
  ...
  "help-02-1": {
    "m": "<h2>如何找出 plus+code 所代表的位置？</h2><p>当您在手机或计算机上输入 plus+code (<b>$EXAMPLE_CODE$</b>) 时，系统会为您找出最近的匹配位置。只要您距离该位置在 40 公里之内，系统即会返回正确的位置信息。</p><p>如果您距离较远，则可以使用城镇或城市名称 (<b>$EXAMPLE_CODE$ Nairobi</b>)，或者输入包含区域代码的 plus+code (<b>$FULL_CODE$</b>)。</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      },
  ...
  "help-02-2": {
    "m": "<h2>我需要申请 plus+code 吗？</h2><p>不需要。各个位置都有对应的 plus+code，所有人均可免费使用。</p><p>要获取某个位置的 plus+code，只需拖动地图以突显所需位置即可。</p>"
  },
  "help-03-0": {
    "m": "<h2>代码由哪些部分组成？</h2><p>以代码 <b>$FULL_CODE$</b> 为例，其中 <b>$CODE_PART_1$</b> 是区域代码（大约 100 平方公里）；<b>$CODE_PART_2$</b> 是城市代码（5 平方公里）；<b>$CODE_PART_3$</b> 是邻域代码（250 平方米）。<b>+</b> 后的 <b>$CODE_PART_4$</b> 是建筑物代码（14 平方米）。如果建筑物尺寸代码涵盖的范围超过一座建筑，则代码可以后跟一位数的门牌号代码。</p><p>一般情况下不需要区域代码，有些情况下也可以不提供城市代码。</p>",
    "p": {
      "CODE_PART_1": {
        "c": "6GCR"
      },
  ...
  "help-03-1": {
    "m": "<h2>一个位置有多个 plus+code 吗？</h2><p>不，每个位置只有一个 plus+code。</p>"
  },
  "help-03-2": {
    "m": "<h2>我可以保存 plus+code 吗？</h2><p>要保存 plus+code，您只需为页面创建一个书签即可。当您打开相应书签时，系统会为您显示对应的位置。</p>"
  },
  "help-03-3": {
    "m": "<h2>此功能可以在没有网络连接的情况下使用吗？</h2><p>可以。当您在手机或计算机上加载此页面之后，系统将会保存该页面的副本。即使您没有网络连接，也可以加载该页面。</p>"
  },
  "help-03-4": {
    "m": "<h2>我可以获得方向信息吗？</h2><p>罗盘模式可以向您展示方向以及您与当前的 plus+code 位置之间的距离。主菜单包含指向不同地图供应商的链接，供您选用。</p>"
  },
  "help-03-5": {
    "m": "<h2>我的 plus+code 区域过大！</h2><p>如果您进一步放大地图，代码对应的区域就会变小。</p>"
  },
  "help-03-6": {
    "m": "<h2>您显示的地址错误！</h2><p>我们提供的地址只是一个建议，它可以用来缩短您需要使用的代码长度。您可以尝试在搜索框中输入其他地址。</p>"
  },
  "input-prompt": {
    "m": "输入 plus+code、地址，或拖动地图"
  },
  "location-prompt": {
    "m": "此服务需要使用您的位置信息。如果浏览器提出相应请求，请允许。"
  },
  "map-error": {
    "m": "无法加载 Google 地图。请确保您的网络连接正常，然后尝试重新加载页面。<br/><br/>您可以输入 plus+code（有无区域代码均可），也可以使用罗盘，不过您只能在地图显示之后输入地址或附带地址的 plus+code。"
  },
  "osm-maps": {
    "m": "打开街道地图"
  },
...
LocalisedMessages["zh-TW"] = {
  ...
  "browser-problem-msg": {
    "m": "您的瀏覽器不支援我們需要的所有功能，如定位與指南針。<br/><br/>建議改用 Chrome、Firefox 或 Opera。"
  },
  "compass-check-fail-msg": {
    "m": "您裝置上的指南針並未回報方向，可能是裝置不支援指南針，或指南針無法正常運作。"
  },
  "compass-check-msg": {
    "m": "讀取指南針時可能發生問題。<br/><br/>若要測試，請將裝置平拿並旋轉一圈。<br/><br/>完整繞完一圈後，請輕按下方按鈕。"
  },
  "compass-check-ok": {
    "m": "您裝置上的指南針沒有問題！"
  },
  ...
  "extend-failure-msg": {
    "m": "若要知道$OLC$位於何處，我們需要您提供目前位置，或在資訊中加入鄉鎮或縣市名稱。<br/><br/>請確認瀏覽器允許定位，且裝置已啟用定位服務。",
    "p": {
      "OLC": {}
    }
  },
  "feedback-detail": {
    "m": "歡迎提供意見。無論是優點或有待改進之處，都請與我們分享，我們會努力改善。"
  },
  "geocode-fail": {
    "m": "Google 的地址服務找不到$ADDRESS$。",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-not-loaded": {
    "m": "Google 地址服務未載入，找不到$ADDRESS$。",
    "p": {
      "ADDRESS": {}
    }
  },
  "geocode-reverse-fail": {
    "m": "無法取得任何地址資訊 (Google 的地理編碼服務發生錯誤)"
  },
  "geocoder-no-info": {
    "m": "Google 的地理編碼服務沒有這個區域的地址資訊。若 40 公里內有較大的鄉鎮，建議使用 plus+code 加上該鄉鎮名稱。"
  },
  "google-maps": {
    "m": "Google 地圖"
  },
  "help-01-0": {
    "m": "<h2>您專屬的私人郵遞區號</h2><p>plus+code 是可代表任何位置或地點的短碼。您可以使用 plus+code 為他人提供快速可靠的指引，協助他們找到您的確切位置。</p>"
  },
  "help-02-0": {
    "m": "<h2>什麼是 plus+code？</h2><p>plus+code 是一種短碼，由 6 或 7 個字母與數字組成，如 <b>$EXAMPLE_CODE$</b>；有時也會加上鄉鎮或縣市名稱，如<b>$EXAMPLE_CODE$奈洛比</b>。</p><p>在不清楚街道名稱或建築物門牌號碼的情況下，您可以藉由 plus+code 為他人提供確切位置。</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      }
  ...
  "help-02-1": {
    "m": "<h2>我要如何找出 plus+code？</h2><p>在手機或電腦上輸入 plus+code (<b>$EXAMPLE_CODE$</b>)，即可找出最接近的結果。只要您位於目標地點約 40 公里的範圍內，這個結果就能顯示正確位置。</p><p>若距離較遠，請使用鄉鎮或縣市名稱 (<b>$EXAMPLE_CODE$奈洛比</b>)，或輸入含區域碼的 plus+code (<b>$FULL_CODE$</b>)。</p>",
    "p": {
      "EXAMPLE_CODE": {
        "c": "MQRG+59"
      },
  ...
  "help-02-2": {
    "m": "<h2>我需要申請 plus+code 嗎？</h2><p>不用，每個地方原本就有 plus+code，且任何人皆可免費使用。</p><p>若要取得某個地點的 plus+code，只要拖曳地圖，標示出想要的地點即可。</p>"
  },
  "help-03-0": {
    "m": "<h2>代碼由哪些部分組成？</h2><p>以我們的範例代碼 <b>$FULL_CODE$</b> 為例，<b>$CODE_PART_1$</b> 是區域碼 (約 100 x 100 公里)；<b>$CODE_PART_2$</b> 是縣市代碼 (5 x 5 公里)；<b>$CODE_PART_3$</b> 是鄰近地區代碼 (250 x 250 公尺)。位於 <b>+</b> 後面的 <b>$CODE_PART_4$</b> 是建築物代碼 (14 x 14 公尺)。若建築物的大小代碼橫跨多棟建築物，可在後面加上單一數字的大門代碼。</p><p>區域碼通常不會用到，有時連縣市代碼也能省略。</p>",
    "p": {
      "CODE_PART_1": {
        "c": "6GCR"
      },
  ...
  "help-03-1": {
    "m": "<h2>一個位置會有多個 plus+code 嗎？</h2><p>不會，任何位置都只有一個 plus+code。</p>"
  },
  "help-03-2": {
    "m": "<h2>我可以儲存 plus+code 嗎？</h2><p>只要為頁面新增書籤，即可儲存 plus+code。日後打開書籤，就能看到地點。</p>"
  },
  "help-03-3": {
    "m": "<h2>沒有網路也可以使用嗎？</h2><p>可以！手機或電腦載入此頁面後，會保留一份副本，即使沒有網路連線也能載入。</p>"
  },
  "help-03-4": {
    "m": "<h2>我可以規劃路線嗎？</h2><p>指南針模式可以顯示您所在位置與目前 plus+code 之間的路線及距離，主選單也提供了多個地圖服務供應商的連結。</p>"
  },
  "help-03-5": {
    "m": "<h2>我的 plus+code 區域過大！</h2><p>若再放大畫面，代碼會顯示較小範圍的區域。</p>"
  },
  "help-03-6": {
    "m": "<h2>您顯示的地址有誤！</h2><p>這裡提供的地址僅供參考，主要目的是縮短您要使用的代碼長度。請在搜尋框裡輸入其他地址。</p>"
  },
  "input-prompt": {
    "m": "請輸入 plus+code、地址，或拖曳地圖"
  },
  "location-prompt": {
    "m": "此服務需要使用您的位置，瀏覽器詢問時請允許使用。"
  },
  "map-error": {
    "m": "無法載入 Google 地圖。請確認網路連線，再嘗試重新載入頁面。<br/><br/>您可以輸入包含或不含區域碼的 plus+code，也可以使用指南針，但須等到地圖顯示後，才能輸入地址或 plus+code 與地址。"
  },
  "osm-maps": {
    "m": "開啟街道地圖"
  },
