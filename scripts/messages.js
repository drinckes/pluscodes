  ...
  this.messages = {
      ...
      'browser-problem-msg': {
          ...
          'pt-BR': '<p>O navegador que você está usando não suporta todas ' +
                ...
                '<p>Nós recomendamos para o Chrome, Firefox ou Opera.</p>',
      ...
      'geocode-fail-limit': {
          ...
          'pt-BR': 'Não foi possível localizar "ADDRESS" (O serviço de ' +
      ...
      'location-prompt': {
          ...
          'fr': 'Ce service doit utiliser votre emplacement. Si votre navigateur demande, se il vous plaît permettre.',
          'pt-BR': 'Este serviço tem de usar a sua localização. Se o seu navegador pergunta, por favor, permita-lo.'
      },
      ...
      'help-01': {
          'en': '<h2>Your own personal postcode</h2>' +
                '<p>plus+codes are short codes for any location, anywhere. You can use them to guide people to your exact location, fast and reliably.</p>'
      },
      // Page 2 explains Plus Codes.
      'help-02': {
          'en': '<h2>What is a plus+code?</h2>' +
                '<p>A plus+code is a short code made up of six or seven letters and numbers, like <b>MQRG+59</b>, or combined with a town or city like this <b>MQRG+59 Nairobi</b>.</p>' +
                '<p>They let you give someone an exact location that doesn\'t depend on street names or building numbers.</p>' +
                '<h2>How do I find out where a plus+code is?</h2>' +
                '<p>When you enter a plus+code (<b>MQRG+59</b>) on your phone or computer, it will find the nearest match. ' +
                'This will return the correct location as long as you are within about 40 kilometers of the place.</p>' +
                '<p>If you are further away, use the town or city name (<b>MQRG+59 Nairobi</b>), or ' +
                'enter the plus+code including the region code (<b>6GCRMQRG+59</b>).</p>' +
                '<h2>Do I need to apply for a plus+code?</h2>' +
                '<p>No, plus+codes already exist for everywhere and anyone can use them for free.</p>' +
                '<p>To get the plus+code for a place just drag the map to highlight the place you want.</p>'
      },
      // Page 3 answers some FAQ.
      'help-03': {
          'en': '<h2>What are the parts of the code?</h2>' +
                '<p>For our example code <b>6GCRMQRG+59</b>, <b>6GCR</b> is the region code (roughly 100 x 100 kilometers). ' +
                ...
                'It can be followed by a single digit door code, if the building size code extends over more than one building.</p>' +
                '<p>Usually, the region code isn\'t needed, and sometimes you will be able to drop the city code as well.</p>' +
                '<h2>Does a location have more than one plus+code?</h2>' +
                '<p>No. Any place only has one plus+code.</p>' +
                '<h2>Can I save them?</h2>' +
                '<p>To save a plus+code, just create a bookmark for the page. When you open the bookmark, it will show you the place.</p>' +
                '<h2>Can I use this when I don\'t have a network?</h2>' +
                '<p>Yes! After you have loaded this page on your phone or computer, it will keep a copy and let you load it even without a network connection.</p>' +
                '<h2>Can I get directions?</h2>' +
                '<p>There is a compass mode that shows you the direction and distance from where you are to the current plus+code. The main menu has links to different map providers you can use.</p>' +
                ...
                '<p>The address given is just a suggestion. It is used to reduce the length of the code you need to use. You can try other addresses in the search box.</p>'
      },
      // Feedback prompt, displayed in feedback popup.
      'feedback-detail': {
          'en': 'Send feedback. Let us know what you like, or what is not working and we\'ll try to improve.',
          'fr': 'Envoyez vos commentaires. Faites-nous savoir ce que vous aimez, ou ce qui ne fonctionne pas et nous essayons d\'améliorer.',
          'pt-BR': 'Envie seu comentário. Deixe-nos saber o que você gosta, ou o que não está funcionando e vamos tentar melhorar.'
      },
